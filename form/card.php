...
if ($action == 'create' && $user->rights->affaires->write) {
	...
	print '<tr>';
	print '<td>';
	print $langs->trans("userresp").': '. $form->select_dolusers(empty($object->fk_user_resp) ? $user->id : $object->fk_user_resp, 'fk_user_resp', 1, array(), 0, $includeuserlist, '', 0, 0, 0, '', 0, '', '', 1);
	print '</td>';
	print '<td>';
